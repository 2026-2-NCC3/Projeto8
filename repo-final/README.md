...
> Confirme com a coordenação se estes são os professores orientadores da sua turma antes de manter esta lista.
...
| Entregável | Status |
|---|---|
| Backend + banco de dados (API REST) | ✅ Rodando e testado (11/11 testes automatizados) |
| Documentação da API | ✅ `src/Entrega 1/Backend/API.md` |
| App Android (Java) — fluxo Login → Cursos → Agenda | ✅ Código completo — testar no Android Studio (ver seção Instalação) |
| POO e Estrutura de Dados (Aluno, Curso, Atividade, Inscrição, Presença) | ✅ Compilado e executado |
| Diagrama de classes | ✅ `documentos/Entrega 1/diagrama-classes.md` |
| Análise Descritiva de Dados | ✅ `documentos/Entrega 1/Analise-Descritiva-Dados/` |

Todos os dados usados são **fictícios** (gerados por script de seed) — nenhum dado real de aluno foi utilizado.
